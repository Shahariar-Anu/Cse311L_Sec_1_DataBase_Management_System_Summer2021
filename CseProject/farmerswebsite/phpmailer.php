...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$smtpport 	= 587;
	$mailsender = "SK Agriculture";
	$companyname= "SK Agriculture";
	$facebook = "https://www.facebook.com/SK Agriculture";
	$twitter = "https://www.twitter.com/SK Agriculture";
	$youtube = "https://www.youtube.com/SK Agriculture";
	$linkedin = "https://www.linkedin.com/SK Agriculture";
	$companyaddress  = "SK Agriculture";
	$contactno = "7894561230";
	$url = "www.SK Agriculture.com";

      ...
      <div class="container">
		...
		<center><h4>Purchase Order Payment Detail...</h4></center><hr>
							...
							<table  class="table table-striped table-bordered"  style="width:100%">
							  ...
							  $qsql = mysqli_query($con,$sql);
							  while($tk = mysqli_fetch_array($qsql))
							  {
								  $sql1 = "SELECT * FROM product WHERE product_id='$tk[product_id]'";
								  $qsql1 = mysqli_query($con,$sql1);
								  $rs1 = mysqli_fetch_array($qsql1);
								  								  
								  $sql2= "SELECT * FROM customer WHERE customer_id='$tk[customer_id]'";
								  $qsql2 = mysqli_query($con,$sql2);
								  $rs2 = mysqli_fetch_array($qsql2);
								  
								  $purchaseamt = $tk['purchase_amt'];
							  echo "
							  <tr> 
							      <td>&nbsp;$tk1[title]</td>
									  <td>&nbsp;$tk2[customer_name]</td>
									  <td>&nbsp;$tk[purchase_order_date]</td>
									  <td>&nbsp;$tksymbol $tk[purchase_amt]</td>
									  <td>&nbsp;$tk[quantity] $tk1[quantity_type]</td>
									  <td>&nbsp;$tk[status]</td>	
						      </tr>";
							  }
							  ?>
...
<div class="form-row">
	...
	Payment Type: <font color="#FF0000">*</font>
	  <select name="paymenttype" id="select" autofocus class="form-control">
			  ...
			  <?php
			  $arr= array("Visa","Master Card","Taka");
			  foreach($arr as $val)
			  {

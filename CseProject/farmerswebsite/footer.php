  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            <h3>SK Agriculture</h3>
            <p>
              Baridhara, DOHS<br>
               Dhaka <br><br>
              <strong>Phone:</strong> +88012546525<br>
              <strong>Email:</strong> info@skagriculture.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>SK Group of LTD</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          
          Designed by SK Group of LTD.
        </div>
      </div>

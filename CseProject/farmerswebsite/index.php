    ...
    <nav class="navbar navbar-expand-md navbar-light shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img class="img-responsive" src="images/Example logo.png" alt="Logo">
            </a>
        ...
        <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Factories.html">Top Sellers</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="bg-img">
        <div class="overlay">
            ...
            <div class="home-page-content">
                <h1 class="text-center home-page-text h1-responsive">ONLINE FARMERS SHOP</h1>
                ...
                <div class="home-buttons text-center fadeIn">
                    <a href="services.html">
                        <div class="btn homepage-btn-1 btn-lg mt-2">Login</div>
                        <div class="btn homepage-btn-2 btn-lg mt-2">Sign UP</div>
                    </a>
                </div>
            </div>
            <!-- /Home page content -->

...
{
	$to = "SK Agriculture@gmail.com";
	$subject = "Message from SK Agriculture";		
	$message = "<html>
	<head>
	<title>SK Agriculture Contact Us form</title>
	</head>
	<body>
	<p>SK Agriculture Contact Us form</p>
	<table>
	<tr>
	<th>Name</th>
	<td>$_POST[name]</td>
	...
	sendmail($to, "SK Agriculture" , $subject, $message);
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4372.265609844019!2d90.41123369502175!3d23.812487257416166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c6556f8d0183%3A0xaad698adc3e0f420!2sDOHS%20Baridhara%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1631954216592!5m2!1sen!2sbd" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            <div class="info mt-4">
              <i class="icofont-google-map"></i>
              <h4>Location:</h4>
              <p>Block B, Baridhara DOHS, Dhaka</p>
            </div>
            <div class="row">
